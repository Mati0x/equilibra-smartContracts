...
//     /**
//      * @custom:change
//      * This information is all packed in ParticipantInfo struct, inisde participantAmountStaked mapping
//      */
...
//         /**
//          * @custom:change
//          * V1 doesnt checks if _projectSupports.length == 0 
//          * V1 doesnt checks if _projectSupports.length == 1
//          * Assumes that length is always valid (length > 1) 
//          */
...
//     ) public view returns (uint256) {
//         return
//             poolProjects[_projectId].participantSupportAt[getCurrentRound()][
//                 _participant
//             ];
//     }
//     /**
...
//     }
//     /**
//      * @custom:change ref{PoolV2} 
//      * Information is in participantAmountStaked[_participant].amountStaked {uint}
//      * V2 returns 2 values instead of 1 {amountStaked,freeStake}
//      */
