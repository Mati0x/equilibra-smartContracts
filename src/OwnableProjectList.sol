...
import {IProjectList, Project, ProjectAlreadyInList, ProjectDoesNotExist, ProjectNotInList} from "./interfaces/IProjectList.sol";
...
contract OwnableProjectList is Ownable, IProjectList {
    ...
    function addProject(
        uint256 _projectId
    ) public onlyOwner isValidProject(_projectId) {
