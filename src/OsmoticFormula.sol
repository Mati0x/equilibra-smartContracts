...
// Exported struct for better Formula parameter handling
...
abstract contract Formula is Initializable {
    ...
    /* *************************************************************************************************************************************/
    /* ** Internal Formula Params Functions                                                                                                     ***/
    /* *************************************************************************************************************************************/
    ...
    function _setFormulaDecay(uint256 _decay) internal {
    ...
    function _setFormulaDrop(uint256 _drop) internal {
    ...
    function _setFormulaMaxFlow(uint256 _maxFlow) internal {
    ...
    function _setFormulaMinStakeRatio(uint256 _minStakeRatio) internal {
