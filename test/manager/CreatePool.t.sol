...
// forge test --match-contract ManagerNewPool_Safe_Combo -vvvv
contract ManagerNewPool_Safe_Combo is ManagerSetup {
    ...
    function test_createPool_paused() external {
        ...
        // assertEq(mngr.isPool(pool), true);
        // assertEq(mngr.isMultisig(safe), true);
        // assertEq(OwnableUpgradeable(pool).owner(), poolOwner);
    }
